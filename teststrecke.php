...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="#"><i class="fab fa-battle-net"> Autovermietung</a>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item  active">
        <a class="nav-link" href="teststrecke.php">Teststrecken<span class="sr-only">(current)</span></a>
      </li>
...
echo ' </nav>';
    ...
    for($tstrecke = 0 ;$tstrecke <mysqli_num_rows($streckeres);$tstrecke++){
        ...
        <img class="card-img-top" src="'.$Timg.'" style="height:300px;"  alt="..">
          ...
          <label>
            <h5 class="card-title"><u>'.$Tname.' </u></h5>
              ...
              <br> nur Sport,Luxus,Elektro Autos! 
              </label>
          </div>
        </div>
          </div>
